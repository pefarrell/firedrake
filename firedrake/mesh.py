...
class ExtrudedMesh(Mesh):
    ...
    :arg extrusion_type: refers to how the coordinates are computed for the
                         ...
                         `radial_hedgehog`: radially extrude
                         coordinates in the direction of the
                         outward-pointing cell normal (produces a
                         P1dgxP1 coordinate field).

                         In the case of `radial_hedgehog` extrusion,
